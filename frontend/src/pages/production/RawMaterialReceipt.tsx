...
import api, { productTypeApi, rawMaterialCategoryApi, riceVarietyApi, materialReceiptApi } from '../../services/api';
const supplierApi = { getAll: async (_p?: any) => ({ data: { data: [] as any[] } }), create: async (_p?: any) => ({ data: { id: 1, data: { id: 1 } } }) };
const purchaseOrderApi = { getAll: async (_p?: any) => ({ data: { data: [] as any[] } }), getReceivableItems: async (_id: number) => ({ data: { data: { po: { id: 1, Supplier: { id: 1, name: '' } } as any, receivableItems: [] as any[] } } }) };
