...
export class T_getStocks_headers {
  @IsNotEmpty({ message: 'authorization cannot be empty' })
  @IsString({ message: 'authorization must be a string' })
  authorization!: string
}
export class T_getStocks_query {
  @IsOptional()
...
export type T_getStocks = (request: {
  headers: T_getStocks_headers
  query: T_getStocks_query
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/stocks';
export const alias = 'T_getStocks';
