...
export class T_getWorksheets_query {
  @IsOptional()
...
export type T_getWorksheets = (request: {
  headers: T_getWorksheets_headers
  query: T_getWorksheets_query
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/worksheets';
export const alias = 'T_getWorksheets';
