...
export class T_getInvoiceItems_headers {
  @IsNotEmpty({ message: 'authorization cannot be empty' })
  @IsString({ message: 'authorization must be a string' })
  authorization!: string
}
export class T_getInvoiceItems_path {
...
export type T_getInvoiceItems = (request: {
  headers: T_getInvoiceItems_headers
  path: T_getInvoiceItems_path
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/invoices/:id/items';
export const alias = 'T_getInvoiceItems';
