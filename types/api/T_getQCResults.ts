...
export class T_getQCResults_headers {
  @IsNotEmpty({ message: 'authorization cannot be empty' })
  @IsString({ message: 'authorization must be a string' })
  authorization!: string
}
export class T_getQCResults_query {
  @IsOptional()
...
export type T_getQCResults = (request: {
  headers: T_getQCResults_headers
  query: T_getQCResults_query
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/qc-results';
export const alias = 'T_getQCResults';
