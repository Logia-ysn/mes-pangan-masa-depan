...
export class T_getStockOpnames_headers {
  @IsNotEmpty({ message: 'authorization cannot be empty' })
  @IsString({ message: 'authorization must be a string' })
  authorization!: string
}
export class T_getStockOpnames_query {
  @IsOptional()
...
export type T_getStockOpnames = (request: {
  headers: T_getStockOpnames_headers
  query: T_getStockOpnames_query
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/stock-opnames';
export const alias = 'T_getStockOpnames';
