...
export class T_getUsers_headers {
  @IsNotEmpty({ message: 'authorization cannot be empty' })
  @IsString({ message: 'authorization must be a string' })
  authorization!: string
}
export class T_getUsers_query {
  @IsOptional()
...
export type T_getUsers = (request: {
  headers: T_getUsers_headers
  query: T_getUsers_query
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/users';
export const alias = 'T_getUsers';
