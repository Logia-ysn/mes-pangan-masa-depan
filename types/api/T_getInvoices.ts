...
export class T_getInvoices_headers {
  @IsNotEmpty({ message: 'authorization cannot be empty' })
  @IsString({ message: 'authorization must be a string' })
  authorization!: string
}
export class T_getInvoices_query {
  @IsOptional()
...
export type T_getInvoices = (request: {
  headers: T_getInvoices_headers
  query: T_getInvoices_query
}, response: Response) => Promise<ReturnType_0>;

export const method = 'get';
export const url_path = '/invoices';
export const alias = 'T_getInvoices';
